  ...
  return (
    (<svg
      ...
      <path
        ...
        className="fil-[#E5E5E5] dark fill-[#404040]" />
      <path
      ...
      <path
        ...
        className="fill-whit dark fill-[#1b1b1b]" />
      <g clip-path="url(#clip0_514_20855)">
        <path
          ...
          className="fil-[#E5E5E5] troke-[#E5E5E5] stroke-[0.5] dark fill-[#404040] dark stroke-[#404040]" />
      </g>
      <circle cx="189" cy="28" r="9" className="fill-whit dark fill-[#262626]" />
      <circle cx="189" cy="28" r="4" className="fil-[#E5E5E5] dark fill-[#404040]" />
      {src && (
        <image
          href={src}
          width="360"
          height="800"
          className="size-full object-cover rounded-lg mx-auto p-3"
      ...
      <defs>
        <clipPath id="clip0_514_20855">
          <rect
            ...
            rx="33"
            ry="25"
            className="fill-whit dark fill-[#262626]"
